...
export type RuleId = 'SIS_CHUNK_SHAPE' | 'SIS_INDEX_INVALID' | 'SIS_BLOCK_TYPE_CONFLICT' | 'SIS_BLOCK_START_DUPLICATE' | 'SIS_BLOCK_END_DUPLICATE' | 'SIS_BLOCK_END_MISMATCH' | 'SIS_STRAGGLER' | 'SIS_TOOL_ID_EMPTY' | 'SIS_TOOL_ID_CHANGED' | 'SIS_TOOL_ID_DUPLICATE' | 'SIS_TOOL_NAME_MISSING' | 'SIS_TOOL_NAME_CHANGED' | 'SIS_ARGUMENTS_INVALID_JSON' | 'SIS_USAGE_DUPLICATE' | 'SIS_FINISH_DUPLICATE' | 'SIS_AFTER_FINISH' | 'SIS_FINISH_MISSING' | 'SIS_FINISH_TOOL_MISMATCH' | 'SIS_REPLAY_STATE_INVALID' | 'SIS_LIMIT_EXCEEDED' | 'SIS_UNKNOWN_CHUNK';
